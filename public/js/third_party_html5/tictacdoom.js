...
var game = {
  board: [[null, null, null], [null, null, null], [null, null, null]], // Rows of the game grid in 2D array form.
...
function gameOver(winCase) {
  ...
  if (winCase === game.playerMark) {
    ...
    $('#game-end-subheading').text(
      'Perhaps their feud will be settled in another life, another dimension...'
    );
  }
}
