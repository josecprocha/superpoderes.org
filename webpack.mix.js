...
mix
  ...
  .copy(
    ...
    'public/js/Draggable.min.js',
  )
  .copy(
    'node_modules/gsap/src/minified/TimelineMax.min.js',
    'public/js/TimelineMax.min.js',
  )
  .copy(
  ...
  .copy(
    ...
    'public/js/jquery.jplayer.min.js',
  )
  ...
  ) // problematic package: depends on "jQuery"
  */
  .copy(
  ...
  .copy(
    'node_modules/obelisk.js/build/obelisk.min.js',
    'public/js/obelisk.min.js',
  )
  ...
  .copy(
    ...
    'public/js/redux-saga.umd.min.js',
  )
  ...
  .sass(
    ...
    'public/css/third_party_html5/platform.css',
  )
  .sass(
    'resources/sass/third_party_html5/reactionB.scss',
    'public/css/third_party_html5/reactionB.css',
  )
  .sass(
    'resources/sass/third_party_html5/shootthetarget.scss',
    'public/css/third_party_html5/shootthetarget.css',
  )
  .sass(
    'resources/sass/third_party_html5/fish.scss',
    'public/css/third_party_html5/fish.css',
  )
  .sass(
    'resources/sass/third_party_html5/vdasteroids.sass',
    'public/css/third_party_html5/vdasteroids.css',
  )
  .sass(
    'resources/sass/third_party_html5/breakout.scss',
    'public/css/third_party_html5/breakout.css',
  )
  .sass(
    'resources/sass/third_party_html5/whackamoleB.scss',
    'public/css/third_party_html5/whackamoleB.css',
  )
  .sass(
    'resources/sass/third_party_html5/shootinghoops.scss',
    'public/css/third_party_html5/shootinghoops.css',
  )
  // Keyboard Action
  .sass(
    'resources/sass/third_party_html5/cybersnake.scss',
    'public/css/third_party_html5/cybersnake.css',
  )
  // Puzzles and Mind Sport
  .sass(
    'resources/sass/third_party_html5/hanoi.scss',
    'public/css/third_party_html5/hanoi.css',
  )
  .sass(
    'resources/sass/third_party_html5/gomoku.scss',
    'public/css/third_party_html5/gomoku.css',
  )
  .less(
    'resources/less/third_party_html5/mahjongg.less',
    'public/css/third_party_html5/mahjongg.css',
  )
  .sass(
    'resources/sass/third_party_html5/chroma.scss',
    'public/css/third_party_html5/chroma.css',
  )
  .sass(
    'resources/sass/third_party_html5/15.scss',
    'public/css/third_party_html5/15.css',
  )
  .sass(
    'resources/sass/third_party_html5/themine.scss',
    'public/css/third_party_html5/themine.css',
  )
  .sass(
    'resources/sass/third_party_html5/align4.scss',
    'public/css/third_party_html5/align4.css',
  )
  .sass(
    'resources/sass/third_party_html5/tetrisB.scss',
    'public/css/third_party_html5/tetrisB.css',
  )
  .sass(
    'resources/sass/third_party_html5/solitaire.scss',
    'public/css/third_party_html5/solitaire.css',
  )
  .sass(
    'resources/sass/third_party_html5/noughtsncrosses.scss',
    'public/css/third_party_html5/noughtsncrosses.css',
  )
  .sass(
    'resources/sass/third_party_html5/risk.scss',
    'public/css/third_party_html5/risk.css',
  )
  // Experiments and Science
  .sass(
    'resources/sass/third_party_html5/planetsquiz.scss',
    'public/css/third_party_html5/planetsquiz.css',
  )
  .sass(
    'resources/sass/third_party_html5/lunarlander.scss',
    'public/css/third_party_html5/lunarlander.css',
  )
  .sass(
    'resources/sass/third_party_html5/multiplicationtoy.scss',
    'public/css/third_party_html5/multiplicationtoy.css',
  )
  // Art
  .sass(
    'resources/sass/third_party_html5/pianokeyboard.scss',
    'public/css/third_party_html5/pianokeyboard.css',
  )
  .sass(
    'resources/sass/third_party_html5/animatedguitar.scss',
    'public/css/third_party_html5/animatedguitar.css',
  )
  // Esports and Challenge
  // Memory Championship Training
  .sass(
    'resources/sass/third_party_html5/memory.scss',
    'public/css/third_party_html5/memory.css',
  )
  // Friends
  /* Need to discover a way to @import "compass/css3"
  .compass(
    'resources/sass/third_party_html5/tictactoe.scss',
    'public/css/third_party_html5/tictactoe.css'
  )
  */
  .sass(
    'resources/sass/third_party_html5/dots.scss',
    'public/css/third_party_html5/dots.css',
  )
  // Fun and Rest
  // Mental Calculation and Math
  .sass(
    'resources/sass/third_party_html5/arithmetic.sass',
    'public/css/third_party_html5/arithmetic.css',
  )
  .sass(
    'resources/sass/third_party_html5/2048.scss',
    'public/css/third_party_html5/2048.css',
  )
  .sass(
    'resources/sass/third_party_html5/3072.scss',
    'public/css/third_party_html5/3072.css',
  )
  // Language
  .sass(
    'resources/sass/third_party_html5/wordsearch2.scss',
    'public/css/third_party_html5/wordsearch2.css',
  );
