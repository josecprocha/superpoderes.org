  ...
  g.SnakeTile.prototype.update = function(i) {
    ...
    if (i == 0) {
      ...
      this.blur =
        ...
        Math.sin(this.parentState.time.elapsed / 200) * this.parentState.dimAvg * 0.015;
    ...
    this.rotation =
      (this.parentState.snake.justAteTick / this.parentState.snake.justAteTickMax) * 90;
    this.scale =
      1 + (this.parentState.snake.justAteTick / this.parentState.snake.justAteTickMax) * 1;
  };
