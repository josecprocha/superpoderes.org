...
(function() {
  ...
  var draw_fish = function(fish) {
    ...
    ctx.quadraticCurveTo(fish.x + fish.s * fish.pos, fish.y - fish.s, fish.x + fish.s * 2 * fish.pos, fish.y);
    ctx.quadraticCurveTo(fish.x + fish.s * fish.pos, fish.y + fish.s, fish.x, fish.y + fish.s);
    ctx.quadraticCurveTo(fish.x - fish.s / 2 * fish.pos, fish.y + fish.s, fish.x - fish.s * 1.5 * fish.pos, fish.y + fish.s / 3);
    ctx.quadraticCurveTo(fish.x - fish.s * 2 * fish.pos, fish.y + fish.s / 2.5, fish.x - fish.s * 2.5 * fish.pos, fish.y + fish.s / 1.5);
    ctx.quadraticCurveTo(fish.x - fish.s * 2 * fish.pos, fish.y, fish.x - fish.s * 2.5 * fish.pos, fish.y - fish.s / 1.5);
    ctx.quadraticCurveTo(fish.x - fish.s * 2 * fish.pos, fish.y - fish.s / 2.5, fish.x - fish.s * 1.5 * fish.pos, fish.y - fish.s / 3);
    ctx.quadraticCurveTo(fish.x - fish.s / 2 * fish.pos, fish.y - fish.s, fish.x, fish.y - fish.s);
    ctx.closePath();
    ctx.fill();
    ctx.stroke();
    ctx.beginPath();
